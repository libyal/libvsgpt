...
#if !defined( _VSGPT_TEST_GETOPT_H )
#define _VSGPT_TEST_GETOPT_H
...
#define vsgpt_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsgpt_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VSGPT_TEST_GETOPT_H ) */
