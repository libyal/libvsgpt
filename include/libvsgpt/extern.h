...
#if !defined( _LIBVSGPT_EXTERN_H )
#define _LIBVSGPT_EXTERN_H

/* To export functions from the libvsgpt DLL define LIBVSGPT_DLL_EXPORT
 * To import functions from the libvsgpt DLL define LIBVSGPT_DLL_IMPORT
