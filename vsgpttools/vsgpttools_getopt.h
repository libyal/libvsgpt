...
#if !defined( _VSGPTTOOLS_GETOPT_H )
#define _VSGPTTOOLS_GETOPT_H
...
typedef struct vsgpttools_option vsgpttools_option_t;

struct vsgpttools_option
{
...
#define vsgpttools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vsgpttools_getopt(
                  int argument_count,
...
void vsgpttools_getopt_wrapped_fprint(
      FILE *stream,
...
void vsgpttools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vsgpttools_option_t *options,
      int number_of_options );

int vsgpttools_getopt_get_options_string(
     const vsgpttools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _VSGPTTOOLS_GETOPT_H ) */
