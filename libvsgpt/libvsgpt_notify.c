...
{
	static char *function = "libvsgpt_notify_set_stream";
...
int libvsgpt_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsgpt_notify_stream_open";
...
int libvsgpt_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvsgpt_notify_stream_close";
