     ...
     libcerror_error_t **error )
{
	...
	static char *function                                     = "libvsgpt_volume_open_read";
	int result                                                = 0;
	...
	if( libvsgpt_volume_read_partition_entries(
	     internal_volume,
	     file_io_handle,
	     0,
	     master_boot_record,
     ...
     libcerror_error_t **error )
{
	...
	static char *function                             = "libvsgpt_volume_read_partition_entries";
