...
{
	static char *function = "libvsgpt_sector_data_initialize";
	...
	*sector_data = memory_allocate_structure(
	...
	if( memory_set(
	     *sector_data,
	     0,
	     sizeof( libvsgpt_sector_data_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libvsgpt_sector_data_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsgpt_sector_data_free";
	int result            = 1;
...
int libvsgpt_sector_data_read_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsgpt_sector_data_read_file_io_handle";
...
int libvsgpt_sector_data_read_element_data(
     ...
     int element_index,
     int element_data_file_index LIBVSGPT_ATTRIBUTE_UNUSED,
     off64_t element_data_offset,
     size64_t element_data_size,
     uint32_t element_data_flags LIBVSGPT_ATTRIBUTE_UNUSED,
     uint8_t read_flags LIBVSGPT_ATTRIBUTE_UNUSED,
     libcerror_error_t **error )
{
	...
	LIBVSGPT_UNREFERENCED_PARAMETER( element_data_flags );
	LIBVSGPT_UNREFERENCED_PARAMETER( read_flags );
	...
	if( libvsgpt_sector_data_initialize(
	     &sector_data,
	...
	if( libvsgpt_sector_data_read_file_io_handle(
	     sector_data,
	     file_io_handle,
             element_data_offset,
	     error ) != 1 )
	...
	if( libfdata_vector_set_element_value_by_index(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) &libvsgpt_sector_data_free,
