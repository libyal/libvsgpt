...
/* Prints the MBR partition entry flags
 */
     ...
     libcerror_error_t **error )
{
	...
	static char *function       = "libvsgpt_debug_print_guid_value";
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libvsgpt_debug_print_utf16_string_value";
...
int libvsgpt_debug_print_read_offsets(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvsgpt_debug_print_read_offsets";
	off64_t offset        = 0;
	size64_t size         = 0;
