...
#if !defined( _LIBVSGPT_LIBCTHREADS_H )
#define _LIBVSGPT_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBVSGPT )
#define HAVE_LIBVSGPT_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBVSGPT_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBVSGPT_LIBCTHREADS_H ) */
