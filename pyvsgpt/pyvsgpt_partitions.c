...
PySequenceMethods pyvsgpt_partitions_sequence_methods = {
	/* sq_length */
	(lenfunc) pyvsgpt_partitions_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyvsgpt_partitions_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyvsgpt_partitions_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyvsgpt.partitions",
	/* tp_basicsize */
	sizeof( pyvsgpt_partitions_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyvsgpt_partitions_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyvsgpt_partitions_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyvsgpt sequence and iterator object of partitions",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyvsgpt_partitions_iter,
	/* tp_iternext */
	(iternextfunc) pyvsgpt_partitions_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyvsgpt_partitions_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyvsgpt_partitions_new(
           ...
           int number_of_items )
{
	pyvsgpt_partitions_t *sequence_object = NULL;
	static char *function                 = "pyvsgpt_partitions_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyvsgpt_partitions_type_object );
...
{
	static char *function = "pyvsgpt_partitions_init";
      ...
      pyvsgpt_partitions_t *sequence_object )
{
	...
	static char *function       = "pyvsgpt_partitions_free";
...
Py_ssize_t pyvsgpt_partitions_len(
            pyvsgpt_partitions_t *sequence_object )
{
	static char *function = "pyvsgpt_partitions_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function      = "pyvsgpt_partitions_getitem";
...
PyObject *pyvsgpt_partitions_iter(
           pyvsgpt_partitions_t *sequence_object )
{
	static char *function = "pyvsgpt_partitions_iter";
...
{
	PyObject *partition_object = NULL;
	static char *function      = "pyvsgpt_partitions_iternext";
